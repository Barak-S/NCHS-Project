...
export default function Footer(){
    return(
        <div className="footer">
            ...
            <button style={{backgroundColor: "#F8981C", color: "#fff", width: 145, padding: 8.5, fontWeight: "700", fontSize:13.5, borderRadius: 40, borderColor: "#F8981c", marginTop: 26,}}>CONTACT US</button>
        </div>
    )
}